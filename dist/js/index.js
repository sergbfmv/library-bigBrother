...
var API_URL = 'https://immense-eyrie-29705.herokuapp.com/';
function getBooks(_x) {
  return _getBooks.apply(this, arguments);
}

function _getBooks() {
  _getBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(id) {
    var res;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("".concat(API_URL, "api/books/").concat(id || ''));
...
function _getLabels() {
  _getLabels = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
    var res;
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("".concat(API_URL, "api/label"));
...
function getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"cart__rating-star\" src=\"img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(rating, "\">"));
    } else if (i < rating) {
...
function renderListBooks() {
  return _renderListBooks.apply(this, arguments);
} //substring a cut string for parametrs - start 0 to 80

function _renderListBooks() {
  _renderListBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            books.forEach(function (data) {
              //data may be destructurized like .....(({author, description, id, etc...}) => {your code})
              var item = document.createElement('li');
              item.classList.add('library__item');
              item.innerHTML = "\n      <a href=\"/#/book?id=".concat(data.id, "\">\n        <article class=\"cart\">\n          <div class=\"cart__wrapper\">\n            <img src=\"").concat(API_URL).concat(data.image, "\" alt=\"\u041E\u0431\u043B\u043E\u0436\u043A\u0430 \u043A\u043D\u0438\u0433\u0438 ").concat(data.title, "\" class=\"cart__image\">\n            <p class=\"cart__label\">").concat(labels[data.label], "</p>\n          </div>\n          <div class=\"cart__content\">\n            <h3 class=\"cart__title\">").concat(data.title, "</h3>\n            <p class=\"cart__author\">").concat(data.author, "</p>\n            <p class=\"cart__description\">").concat(data.description.substring(0, 100), "...</p>\n            <div class=\"cart__rating\">\n              ").concat(getStars(data.rating).join(''), "\n            </div>\n          </div>\n        </article>\n      </a>\n    ");
...
function renderBook_getStars(rating) {
  var stars = [];
...
function renderBook(_x) {
  return _renderBook.apply(this, arguments);
}

function _renderBook() {
  _renderBook = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(id) {
    var _yield$Promise$all, _yield$Promise$all2, books, labels;
...
var search_search = document.querySelector('.search');
var searchBtn = document.querySelectorAll('.header__btn_search');

function closeSearch(_ref) {
  var target = _ref.target;

  //вытвщиили таргет из ивента деструктуризацией
  if (target.closest('.search, .header__btn_search')) {
    return;
  }

  search_search.classList.remove('search_active');
  document.body.removeEventListener('click', closeSearch);
}

searchBtn.forEach(function (btn) {
  btn.addEventListener('click', function () {
    search_search.classList.add('search_active');
