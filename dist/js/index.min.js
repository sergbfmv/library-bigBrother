...
function addBooks(_x2) {
  return _addBooks.apply(this, arguments);
}

function _addBooks() {
  _addBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(data) {
    var res;
...
function _getLabels() {
  _getLabels = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
    var res;
...
var btnDelete = document.querySelector('.header__btn');
