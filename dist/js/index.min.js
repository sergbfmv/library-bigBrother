...
var API_URL = 'https://evening-brook-86034.herokuapp.com/';
...
function _searchBooks() {
  _searchBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(search) {
    var res;
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("".concat(API_URL, "api/books/?search=").concat(search));
...
function addBooks(_x3) {
  return _addBooks.apply(this, arguments);
}

function _addBooks() {
  _addBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(data) {
    var res;
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return fetch("".concat(API_URL, "api/books/"), {
              method: 'POST',
...
function _getLabels() {
  _getLabels = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
    var res;
...
function deleteBooks(_x4) {
  return _deleteBooks.apply(this, arguments);
}

function _deleteBooks() {
  _deleteBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(id) {
    var res;
...
function editBooks(_x5, _x6) {
  return _editBooks.apply(this, arguments);
}

function _editBooks() {
  _editBooks = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(id, data) {
    var res;
...
var fieldList = document.querySelector('.fields__list_filter');
...
var footerBookLabel = document.querySelector('.footer__btn.book__label');
var timerId;
...
function renderBook_getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"book__rating-star\" src=\"img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(rating, "\">"));
    } else if (i < rating) {
...
function renderBook(_x2) {
  return _renderBook.apply(this, arguments);
}

function _renderBook() {
  _renderBook = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(id) {
...
function closeSearch(_ref, flag) {
...
function sendBook() {
  return _sendBook.apply(this, arguments);
}

function _sendBook() {
  _sendBook = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
